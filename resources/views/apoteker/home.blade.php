                ...
                <div class="col">
                    <div class="card card-login-register">
                        <div class="card-body">
                            ...
                            <div class="row ">
                                <div class="col pt-5 d-flex justify-content-center">
                                    <b style="text-align: center">Silahkan siapkan obat <br> sesuai resep
                                    </b>
                                </div>
                            </div>
                            <div class="row ">
                                <div class="col pt-5 d-flex justify-content-center">
                                    <button class="btn btn-login-register" type="button" data-bs-toggle="modal" data-bs-target="#modal-resep">
                                        <span style="color: white"><b>Lihat Resep<b></span>
                                    </button>
                                </div>
                            </div>
                            <div id="id-antrian-obat" hidden></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="resep-obat" rows="3" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="done()">Selesai</button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('script')
    <script>
        ...
        getAntrianObat = () => {
            $.ajax({
                type: "get",
                url : "{{ url('apoteker/nomor-antrian') }}",
        ...
        setData = (data) => {
            ...
            $("#id-antrian-obat").text(data.id);
            $('#nama-pasien').text(data.pasien.user.name);
            $('#resep-obat').val(data.resep)
        }

        done = () => {
            antrian_id = $('#id-antrian-obat').text();

            $.ajax({
                type: "post",
                url: "{{url('apoteker/antrian-selesai')}}",
                data: {
                ...
                success: function (response) {
                    ...
                    Swal.fire(
                        'Good job!',
                        'obat sudah diberikan, panggil antrian selanjutnya',
                        'success'
                    )
